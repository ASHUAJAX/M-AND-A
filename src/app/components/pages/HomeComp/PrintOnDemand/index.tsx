    ...
    return (
        <>
            <div className=' my-20 m-auto'>
                ...
                <h1 className='w-1/2 m-auto text-center text-5xl font-extrabold'>Create Print-on-Demand shirts with Printify!</h1>
                <div className='flex justify-between items-center px-10 mt-20 gap-20'>
                    {
                        data.map((elm, ix) => (
            ...
            <div className='w-full py-14 bg-primary flex flex-col text-center'>
                <h1 className='text-5xl text-[#2F2E0C] font-extrabold'>
                    Make Print on Demand t-shirts <br /> with Printify
                </h1>
                <p className='my-7'>Start creating shirts online with your own artwork. Simply pick and apply your<br />
